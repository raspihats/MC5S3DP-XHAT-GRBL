...
uint8_t System_GetControlState(void)
{
	...
	uint8_t pin = ((LL_GPIO_IsInputPinSet(GPIO_CTRL_RST_PORT, GPIO_CTRL_RST_PIN)<<CONTROL_RESET_BIT) |
					(LL_GPIO_IsInputPinSet(GPIO_CTRL_FEED_PORT, GPIO_CTRL_FEED_PIN)<<CONTROL_FEED_HOLD_BIT) |
					(LL_GPIO_IsInputPinSet(GPIO_CTRL_START_PORT, GPIO_CTRL_START_PIN)<<CONTROL_CYCLE_START_BIT) |
					(LL_GPIO_IsInputPinSet(GPIO_DOOR_PORT, GPIO_DOOR_PIN)<<CONTROL_SAFETY_DOOR_BIT));
